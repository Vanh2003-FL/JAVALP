...
(id, attr_code, attr_code_name, attr_data_type, active, create_date, create_by, update_date, update_by)
VALUES(nextval('sys_attributes_id_seq'::regclass), 'S', 'status', 'text', true, now(), '', now(), '');
