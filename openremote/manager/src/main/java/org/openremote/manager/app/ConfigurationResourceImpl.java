...
public class ConfigurationResourceImpl extends ManagerWebResource implements ConfigurationResource {
    ...
    @Override
    public String fileUploadExtend(RequestParams requestParams, String path, FileInfo fileInfo) {
        return this.configurationService.saveImageFileExtend(path, fileInfo);
    }
