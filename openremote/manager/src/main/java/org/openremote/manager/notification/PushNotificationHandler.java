...
//        String firebaseConfigFilePath = container.getConfig().get(OR_FIREBASE_CONFIG_FILE) != null ? container.getConfig().get(OR_FIREBASE_CONFIG_FILE) : "D:\\Hanh\\Workspace\\HDI\\Projects\\iotplatformV2\\iotplatform\\iotplatform\\deployment\\manager\\fcm.json";
        String firebaseConfigFilePath = container.getConfig().get(OR_FIREBASE_CONFIG_FILE) != null ? container.getConfig().get(OR_FIREBASE_CONFIG_FILE) : "C:\\Users\\phungvie\\source\\IoT\\iotplatform\\iotplatform\\deployment\\manager\\fcm.json";
...
//                .setTarget("cPTadjv_TY2aB8RL5vK-a3:APA91bHzXYWI-rW9UR7u37VMfbEAYqgtfcxFIBjFmq53Nk9Mk9Lafv1u8lds6O5mnINqSYfU3PP_xcY9V9f76pxW43dM3tcw60CY1HXr605XNKdTwoyaC2I")
//                .setPriority(PushNotificationMessage.MessagePriority.HIGH)
//                .setTtlSeconds(3600L); // 1 hour
//
//        Message message = buildFCMMessage(190887L, pushMsg);
    ...
    public List<Notification.Target> getTargets(Notification.Source source, String sourceId, List<Notification.Target> targets, AbstractNotificationMessage message) {
        ...
        if (targets != null) {
            ...
            targets.forEach(target -> {
                ...
                assetQuery.limit = 1;
                assetQuery.orderBy(new AssetQuery.OrderBy(AssetQuery.OrderBy.Property.LATEST_UPDATE_DATE, false));
...
//        String fcmToken = consoleFCMTokenMap.get(targetId);
        ConsoleAsset asset = (ConsoleAsset) assetStorageService.find(targetId);
        String fcmToken = getFcmToken(asset).orElse(null);
...
//    }
    ...
    protected static Message buildFCMMessage(long id, PushNotificationMessage pushMessage) {
        ...
        com.google.firebase.messaging.Notification.Builder builderNotification = com.google.firebase.messaging.Notification.builder();
        builderNotification.setBody(pushMessage.getBody());
        builderNotification.setTitle(pushMessage.getTitle());
        ...
        builder.setNotification(builderNotification.build());
