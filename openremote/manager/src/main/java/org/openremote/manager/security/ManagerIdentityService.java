...
public class ManagerIdentityService extends IdentityService {
    ...
    public void init(Container container) throws Exception {
        ...
        managerWebService.addApiSingleton(
            new RealmResourceImpl(container.getService(TimerService.class), this, container,persistenceService)
        );
        managerWebService.addApiSingleton(
            new UserResourceImpl(container.getService(TimerService.class), this, mqttBrokerService,messageBrokerService,persistenceService)
        );
    }
