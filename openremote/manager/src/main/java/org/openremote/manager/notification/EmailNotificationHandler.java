...
public class EmailNotificationHandler implements NotificationHandler {
    ...
    public void init(Container container) throws Exception {
        ...
        // Configure SMTP
        String host = container.getConfig().getOrDefault(OR_EMAIL_HOST, "smtp.gmail.com");
        int port = getInteger(container.getConfig(), OR_EMAIL_PORT, OR_EMAIL_PORT_DEFAULT);
//        String user = container.getConfig().getOrDefault(OR_EMAIL_USER, "phungvietdz@gmail.com");
//        String password = container.getConfig().getOrDefault(OR_EMAIL_PASSWORD, "vfep fwad hxsd pano");

        String user = container.getConfig().getOrDefault(OR_EMAIL_USER, "dangdz1362003@gmail.com");
        String password = container.getConfig().getOrDefault(OR_EMAIL_PASSWORD, "wtxy ykzf zpls mubv");

//        String user = container.getConfig().getOrDefault(OR_EMAIL_USER, "vietp8438@gmail.com");
//        String password = container.getConfig().getOrDefault(OR_EMAIL_PASSWORD, "qakg ufgx szij utec");

//        String user = container.getConfig().getOrDefault(OR_EMAIL_USER, "dangdz1362003@gmail.com");
//        String password = container.getConfig().getOrDefault(OR_EMAIL_PASSWORD, "wtxy ykzf zpls mubv");

//        String user = container.getConfig().getOrDefault(OR_EMAIL_USER, "phungtienviet14@gmail.com");
//        String password = container.getConfig().getOrDefault(OR_EMAIL_PASSWORD, "ftff eigp mjty zacw");
...
//        return true;
    ...
    protected void buildEmail(long id, EmailNotificationMessage emailNotificationMessage, MimeMessage email) throws Exception {
        ...
        if (emailNotificationMessage.getText() != null) {
            ...
            email.setContent(emailNotificationMessage.getHtml(), "text/html; charset=UTF-8");
        }
    }
