...
public abstract class KeycloakIdentityProvider implements IdentityProvider {
    ...
    public static final String OR_KEYCLOAK_HOST_DEFAULT = "171.254.94.141"; // Bug in keycloak default hostname provider means localhost causes problems with dev-proxy profile
