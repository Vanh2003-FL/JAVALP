...
import {
  ...
  headerItemSchedule,
  headerItemitSupport, headerItemBlog, headerItemBlogPublic, headerItemCategoryContent,
  headerItemBroadcastSchedule,
  headerItemRapport,
  headerItemHome,
  // headerItemAccount,
  // headerItemAssets,
...
import "./pages/Administration/page-administration";
import { pageAdministrationProvider } from "./pages/Administration/page-administration";

import "./pages/CategoryContent/page-category-content";
import { pageCategoryContentProvider } from "./pages/CategoryContent/page-category-content";

import "./pages/BroadcastSchedule/page-broadcast-schedule";
import { pageBroadcastScheduleProvider } from "./pages/BroadcastSchedule/page-broadcast-schedule";

import { homePageProvider } from "./pages/homePage/homeProvider";
import { rapportPageProvider } from "./pages/rapport/rapportProvider";
...
export const DefaultPagesConfig: PageProvider<any>[] = [
  ...
  pageBlogPublicHomeProvider(store),
  pageBlogPublicDetailProvider(store),
  pageAdministrationProvider(store),
  pageCategoryContentProvider(store),
  pageBroadcastScheduleProvider(store)
];
...
export const DefaultHeaderMainMenu: { [name: string]: HeaderItem } = {
  ...
  home: headerItemHome(orApp),
  rapport: headerItemRapport(orApp),
  ...
  categoryContent: headerItemCategoryContent(orApp),
  broadcastSchedule: headerItemBroadcastSchedule(orApp),
  administration: headerItemAdministration(orApp),
