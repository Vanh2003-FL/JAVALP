...
export class MapWidget extends OrAssetWidget {
    ...
    protected getMarkerTemplates(): TemplateResult[] {
        return this.loadedAssets.filter((asset: AssetInfoDto) => {
            ...
            if (this.markers) {
                ...
                this.markers[asset.asset?.type!] = {attributeName: this.widgetConfig.attributeName!};
                this.markers[asset.asset?.type!].showUnits = this.widgetConfig.showUnits;
                this.markers[asset.asset?.type!].showLabel = this.widgetConfig.showLabels;
                if (this.widgetConfig.valueType == 'boolean') {
                    ...
                    this.markers[asset.asset?.type!].colours = this.widgetConfig.boolColors;
                    ...
                    this.markers[asset.asset?.type!].colours = colors;
                } else {
                    ...
                    this.markers[asset.asset?.type!].colours = colorsNum;
                }
            }
            return html`
