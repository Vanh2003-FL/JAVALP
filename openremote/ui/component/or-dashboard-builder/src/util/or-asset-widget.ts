...
import {Asset, AssetInfoDto, AssetQuery, Attribute, AttributeRef} from "@openremote/model";
...
function isAssetIdLoaded(loadedAssets: AssetInfoDto[] | undefined, assetId: string) {
    return loadedAssets?.find(asset => asset.asset?.id === assetId) !== undefined;
}
