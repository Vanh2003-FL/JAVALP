...
export class OrMwcInput extends LitElement {
    ...
    protected render() {
        ...
        if (this.type) {
            ...
            let labelTemplate = showLabel ? html`<span class="mdc-floating-label ${hasValue ? "mdc-floating-label--float-above" : ""}" id="label"><or-translate value="${this.label}"></or-translate></span>` : undefined;
            ...
            switch (this.type) {
                ...
                case InputType.CHECKBOX:
                    ...
                    return html`
                        <div id="field" class="mdc-form-field">
                            ...
                            <label class="mdc-checkbox-circle" for="elem"><or-translate value="${this.label}"></or-translate></label>
                        </div>
                    `;
                ...
                case InputType.JSON_OBJECT: {
                    ...
                    console.log('value12',ifDefined(valMinMax[1]))
                    if (valMinMax.some((v) => typeof (v) !== "string")) {
                        ...
                        if (this.type === InputType.JSON || this.type === InputType.JSON_OBJECT) {
                            ...
                            console.log('valMinMax',valMinMax)
                        }
                    }
                        ...
                        inputElem = html`
                            <span id="wrapper">
                                ...
                                <div id="component" class="${classMap(classes)}" @MDCSlider:change="${(ev:CustomEvent<MDCSliderChangeEventDetail>) => this.onValueChange(undefined, ev.detail.value)}">
                                   ...
                                   <input id="elem" class="mdc-slider__input" type="range" min="${ifDefined(valMinMax[1])}" max="${ifDefined(valMinMax[2])}" value="${valMinMax[0] || valMinMax[1] || 0}" name="slider" step="10" ?readonly="${this.readonly}" ?disabled="${this.disabled}" aria-label="${ifDefined(this.label)}" />
