...
export async function getAssetsByType(type: string, realm?: string, loadedAssets?: Map<string, AssetInfoDto[]>): Promise<{ assets?: AssetInfoDto[], loadedAssets?: Map<string, AssetInfoDto[]>}> {
