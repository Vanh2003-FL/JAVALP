    ...
    protected render() {
        ...
        return html`
            ...
            `, () => {
                ...
                const asset = idValue && idValue !== "*" ? this._assets!.find(a => a.asset?.id === idValue) : undefined;
                const descriptors = AssetModelUtil.getAttributeAndValueDescriptors(assetType, this.action.attributeName, asset && asset.asset?.attributes && this.action.attributeName ? asset.asset?.attributes[this.action.attributeName] : undefined);
