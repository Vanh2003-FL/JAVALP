...
public class RouteAssetCreateDTO {
    ...
    public RouteAssetCreateDTO() {
    }

    public RouteAssetCreateDTO(Long id, String routeId, String assetId, Long sysAssetTypeId, String activeDate, String deactiveDate, Boolean deleted, String description, String createDate, String createBy, String updateDate, String updateBy) {
        this.id = id;
