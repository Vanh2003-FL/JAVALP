...
import static org.openremote.model.Constants.READ_SCHEDULE;
...
public enum ClientRole {
    ...
    READ_ASSETS_TYPE(Constants.READ_ASSETS_TYPE_ROLE, "Read asset type data"),
    READ_RULES(Constants.READ_RULES_ROLE, "Read rulesets"),
    READ_INSIGHTS(Constants.READ_INSIGHTS_ROLE, "Read dashboards"),
    READ_SCHEDULE(Constants.READ_SCHEDULE, "Read schedule"),
    ...
    WRITE_SCHEDULE(Constants.WRITE_SCHEDULE, "Read schedule"),
