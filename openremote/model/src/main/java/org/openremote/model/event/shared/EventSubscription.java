...
public class EventSubscription<E extends SharedEvent> {
    ...
    public String getHdiEventType() {
        return hdiEventType;
    }

    public void setHdiEventType(Class<E> eventClass) {
        this.hdiEventType = Event.getEventType(eventClass);
    }
