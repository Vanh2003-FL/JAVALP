...
public class AttributeEvent extends SharedEvent implements AttributeInfo {
    ...
    public AttributeEvent(String assetId, String attributeName, Object value,String assetCode) {
        this(new AttributeRef(assetId, attributeName), value);
        this.assetCode = assetCode;
    }
    ...
    public AttributeEvent(boolean send,AttributeRef attributeRef, Object value) {
        this(attributeRef, value, 0L);
        this.send=send;
    }
    ...
    public AttributeEvent(boolean send,AssetInfo asset, Attribute<?> attribute, Object source, Object value, Long valueTimestamp, Object oldValue, Long oldValueTimestamp) {
        this(new AttributeRef(asset.getId(), attribute.getName()),value, valueTimestamp);
    ...
    public AttributeEvent setType(ValueDescriptor<?> valueType) {
