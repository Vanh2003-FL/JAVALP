...
public class User {
    ...
    @Column(name = "is_face_id")
    protected Integer isFaceId;

    @Column(name = "is_finger_id")
    protected Integer isFingerId;
    ...
    public Integer getIsFaceId() {
        return isFaceId;
    }

    public void setIsFaceId(Integer isFaceId) {
        this.isFaceId = isFaceId;
    }

    public Integer getIsFingerId() {
        return isFingerId;
    }

    public void setIsFingerId(Integer isFingerId) {
        this.isFingerId = isFingerId;
    }
