...
public abstract class Asset<T extends Asset<?>> implements IdentifiableEntity<T>, AssetInfo {
    ...
    public Asset(String id, AttributeMap attributes, Date createdOn, String name, String parentId, String[] path, String realm, String type, boolean accessPublicRead, long version) {
        this.id = id;
